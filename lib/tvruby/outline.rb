module TVRuby::Outline
  ...
  public
      ...
      # `aNext', respectively.
      # 
      def initialize (aText, aChildren=nil, aNext=nil, initialState = true)
        next_(aNext)
  ...
  # 
  class TOutlineViewer < TScroller
  public
      #
      ...
      # 
      def getGraph(level, lines, flags)
      end
      ...
      */
      ...
      def createGraph(level, lines, flags, levWidth, endWidth, chars)
      end
      ...
      @graphChars
      class << self; attr_accessor :graphChars; end

      def self.disposeNode(node)
      end
      class << self; protected :disposeNode; end

  private
      def adjustFocus(newFocus)
      end

      def iterate(action, checkResult)
      end
  end
  ...
  public
      ...
      # 
      def initialize(bounds, aHScrollBar, aVScrollBar, aRoot)
      end
